...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var joystickClickFlash: View
...
private fun savePersistentTabs() {
    ...
    private fun showJoystickClickFlash() {
        if (joystickClickFlash.width <= 0 || joystickClickFlash.height <= 0) {
            joystickClickFlash.post { showJoystickClickFlash() }
            return
        }
    ...
    private fun startJoystickCursorInversionEffect() {
        // Disabled: keep the joystick cursor static.
    }
